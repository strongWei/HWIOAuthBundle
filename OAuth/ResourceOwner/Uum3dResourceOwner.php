...
class Uum3dResourceOwner extends GenericOAuth2ResourceOwner
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults(array(
            ...
            'access_token_url' => '172.16.25.4/oauth/v2/token',
            'refresh_token_url' => '172.16.25.4/oauth/v2/token',
            'infos_url' => '172.16.25.4/v1/user',
        ));
    }
